...
{
    public partial class Frm_PagoClientes : Form
    {
        Cls_SQL sql = new Cls_SQL();
        public Frm_PagoClientes()
        {
            InitializeComponent();
        ...
        private void Frm_PagoClientes_Load(object sender, EventArgs e)
        {
            lenarDGV();
        }
        ...
        {
            Dgv_mov.Rows.Clear(); 
            List<MOVIMIENTO> listaMovmientos = sql.obtenerMovimietnoCliente();
